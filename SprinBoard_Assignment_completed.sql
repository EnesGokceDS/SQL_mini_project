SELECT name FROM club_data.facilities
WHERE membercost != 0;
...
#(facilities.name= "Tennis Court 1" OR facilities.name= "Tennis Court 2")
...
SELECT DISTINCT
    ...
    FROM
        club_data.facilities, club_data.members, club_data.bookings
    WHERE
